...
| nextflow-development | env check, FASTQ detection, samplesheet, command build, approved execution wrapper | RNA-seq reached real nf-core tasks on gpu03; ATAC plan completed | guaranteed HPC execution |
