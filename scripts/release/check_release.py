...
REQUIRED_PLUGIN_FILES = {
    ...
    "skills/single-cell-integration/SKILL.md",
    "skills/single-cell-integration/scripts/check_environment.py",
    "skills/single-cell-integration/scripts/run.py",
    "skills/single-cell-marker-de/SKILL.md",
    "skills/single-cell-marker-de/scripts/check_environment.py",
    "skills/single-cell-marker-de/scripts/run.py",
    "skills/single-cell-annotation/SKILL.md",
    "skills/single-cell-annotation/scripts/check_environment.py",
    "skills/single-cell-annotation/scripts/run.py",
    "skills/pathway-enrichment/SKILL.md",
    "skills/pathway-enrichment/scripts/check_environment.py",
    "skills/pathway-enrichment/scripts/run.py",
    "skills/bulk-rna-de/SKILL.md",
    "skills/bulk-rna-de/scripts/check_environment.py",
    "skills/bulk-rna-de/scripts/run.py",
    "skills/scrna-standard-workflow/SKILL.md",
    "skills/scrna-standard-workflow/scripts/check_environment.py",
    "skills/scrna-standard-workflow/scripts/run.py",
