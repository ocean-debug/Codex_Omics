...
def main() -> int:
    parser = argparse.ArgumentParser(description="Summarize a single-cell annotation manifest.")
    ...
    result = {
        ...
        "n_cell_types": summary.get("n_cell_types"),
        "low_confidence_fraction": summary.get("low_confidence_fraction"),
