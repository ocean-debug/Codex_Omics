...
export NXF_APPTAINER_CACHEDIR="${NXF_APPTAINER_CACHEDIR:-$CODEX_OMICS_HOME/tools/nextflow/apptainer-cache}"
...
mkdir -p "$NXF_HOME" "$NXF_SINGULARITY_CACHEDIR" "$NXF_APPTAINER_CACHEDIR" "$APPTAINER_CACHEDIR"
